...
px.to_csv(os.path.join(DATA,'px28_h10.csv'))   # H.10 noon panel, kept for reference; px28.csv is the 5pm bar (build5pm.py)
print('px28_h10',px.shape,px.index.max().date())
