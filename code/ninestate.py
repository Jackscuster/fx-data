...
THE RIBBON SHIPS AT 7 / 28 / 128.

60 CANNOT BE THE SLOW WINDOW. It equals VOLWIN, so
scale = sum|r|_60 / (sd_60 * sqrt(60)) collapses toward the constant sqrt(2/pi)
and the axis loses most of its range: cross-sectional sd 0.343 at 60 against
0.393 at 63 and 0.550 at 72, and churn 92.7 against about 143 on either side. It
was the worst single window in the whole 4-200 sweep. A slow row on 60 moves less
than the others because it has less room to move, which reads as stability and is
not. If the horizon argument ever pulls the slow window back toward 60, use 63.

windowsweep.py over 4-200 pointed at 19 / 105 / 188 on separation and
non-duplication; that is computed alongside so the difference stays visible.
